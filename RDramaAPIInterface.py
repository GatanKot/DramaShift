...
'''
Wrapper around the RDRama API, credit @HeyMoon
'''
...
class RDramaAPIInterface:
    ...
    def reply_to_direct_message(self, message_id: int, message: str):
        ...
        return self.post(url, data={
            ...
            500])  # There is a bug (probably) with the site that causes 500 errors to be sent when doing this via json. TODO: Ask Aevann why
